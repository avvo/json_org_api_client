...
module JsonOrgApiClient
  class Resource
    ...
    class << self
      ...
      def key_formatter
        JsonOrgApiClient::Formatter.formatter_for(json_key_format)
      end

      def route_formatter
        JsonOrgApiClient::Formatter.formatter_for(route_format)
      end
      ...
      def _header_store
        Thread.current["json_org_api_client-#{resource_name}"] ||= {}
      end
